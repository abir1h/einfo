...
class PopupWidget extends StatefulWidget {
  ...
  final ValueChanged<bool>? onPopUpDone;
  ...
  PopupWidget(
      ...
      this.onHitTest,   this.onPopUpDone})
...
class _PopupWidgetState extends State<PopupWidget> {
  ...
  _onWidgetTap(BuildContext context) {
    ...
    if ((widget.child.key as GlobalKey).currentContext != null &&
      ...
      Navigator.push(context, PopupWidgetModal(child: child)).then((e){
       widget.onPopUpDone?.call(true);
      });
    }
  }
}
